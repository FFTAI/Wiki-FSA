...
def main():
    ...
    if server_ip_list:
        ...
        for i in range(len(server_ip_list)):
            ...
            time.sleep(0.01)
            # fsa.set_home_offset_group(server_ip_list[i])
        ...
        #     for i in range(len(server_ip_list)):
        #         fsa.set_current_control(server_ip_list[i],-1.3)
        #     print('set current 2\n')
        ...
        #     for i in range(len(server_ip_list)):
        #         fsa.set_velocity_control(server_ip_list[i], -10)
        #     print('set velocity 2\n')

        # elif control_mode == "P":
        #     # set current control current to 0.0
        #     pvc = fsa.get_pvc(server_ip_list[0])
        #     try:
        #         print("Position = %.2f, Velocity = %.0f, Current = %.4f" % (pvc[0], pvc[1], pvc[2]))
        #     except:
        #         pass
        #     time.sleep(0.01)
        #     for i in range(len(server_ip_list)):
        #         fsa.set_position_control(server_ip_list[i], pvc[0])
        ...
        #         time.sleep(0.01)
        #         if control_mode == "P":
        #             fsa.set_position_control(server_ip_list[0], -i/50)
        ...
        #         time.sleep(0.01)
        #         if control_mode == "P":
        #             fsa.set_position_control(server_ip_list[0], -10+i/50)
