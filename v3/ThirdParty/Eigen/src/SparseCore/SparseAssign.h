...
template < typename Derived > template < typename OtherDerived > inline Derived& SparseMatrixBase< Derived >::operator=( const SparseMatrixBase< OtherDerived >& other ) {
    ...
    internal::Assignment< Derived, OtherDerived, internal::assign_op< Scalar, typename OtherDerived::Scalar > >::run( derived(), other.derived(),
...
namespace internal {
    ...
    template <> struct storage_kind_to_evaluator_kind< Sparse > { typedef IteratorBased Kind; };
    ...
    template < typename DstXprType, typename Func1, typename Func2 > struct assignment_from_dense_op_sparse {
        ...
        static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE typename internal::enable_if< internal::is_same< typename internal::evaluator_traits< Rhs >::Shape, DenseShape >::value >::type
...
#define EIGEN_CATCH_ASSIGN_DENSE_OP_SPARSE( ASSIGN_OP, BINOP, ASSIGN_OP2 )                                                                                                             \
    ...
    struct Assignment< DstXprType, CwiseBinaryOp< internal::BINOP< Scalar, Scalar >, const Lhs, const Rhs >, internal::ASSIGN_OP< typename DstXprType::Scalar, Scalar >, Sparse2Dense, \
        ...
        : assignment_from_dense_op_sparse< DstXprType, internal::ASSIGN_OP< typename DstXprType::Scalar, typename Lhs::Scalar >,                                                       \
    ...
    template < typename DstXprType, typename SrcXprType, typename Functor > struct Assignment< DstXprType, SrcXprType, Functor, Diagonal2Sparse > {
        ...
        template < int Options, typename AssignFunc > static void run( SparseMatrix< Scalar, Options, StorageIndex >& dst, const SrcXprType& src, const AssignFunc& func ) {
