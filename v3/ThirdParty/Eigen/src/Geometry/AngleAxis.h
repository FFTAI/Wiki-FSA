...
namespace internal {
    template < typename _Scalar > struct traits< AngleAxis< _Scalar > > { typedef _Scalar Scalar; };
}  // namespace internal
...
public:
    ...
    template < typename Derived > EIGEN_DEVICE_FUNC inline explicit AngleAxis( const MatrixBase< Derived >& m ) {
        *this = m;
    }
 ...
 * This function implicitly normalizes the quaternion \a q.
 */
template < typename Scalar > template < typename QuatDerived > EIGEN_DEVICE_FUNC AngleAxis< Scalar >& AngleAxis< Scalar >::operator=( const QuaternionBase< QuatDerived >& q ) {
 ...
 **/
template < typename Scalar > template < typename Derived > EIGEN_DEVICE_FUNC AngleAxis< Scalar >& AngleAxis< Scalar >::fromRotationMatrix( const MatrixBase< Derived >& mat ) {
    return *this = QuaternionType( mat );
}
