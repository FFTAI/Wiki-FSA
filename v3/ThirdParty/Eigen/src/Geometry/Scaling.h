...
template < typename Derived, typename Scalar > EIGEN_EXPR_BINARYOP_SCALAR_RETURN_TYPE( Derived, Scalar, product ) operator*( const MatrixBase< Derived >& matrix, const UniformScaling< Scalar >& s ) {
