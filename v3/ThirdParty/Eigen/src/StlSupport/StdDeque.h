...
#define EIGEN_DEFINE_STL_DEQUE_SPECIALIZATION( ... )                                                                                                                       \
    namespace std {                                                                                                                                                        \
    template <> class deque< __VA_ARGS__, std::allocator< __VA_ARGS__ > > : public deque< __VA_ARGS__, EIGEN_ALIGNED_ALLOCATOR< __VA_ARGS__ > > {                          \
    ...
    public:                                                                                                                                                                \
        ...
        template < typename InputIterator > deque( InputIterator first, InputIterator last, const allocator_type& a = allocator_type() ) : deque_base( first, last, a ) {} \
...
template < typename T >
class deque< T, EIGEN_ALIGNED_ALLOCATOR< T > > : public deque< EIGEN_WORKAROUND_MSVC_STL_SUPPORT( T ), Eigen::aligned_allocator_indirection< EIGEN_WORKAROUND_MSVC_STL_SUPPORT( T ) > > {
