...
public:
    ...
    template < class U > struct rebind { typedef aligned_allocator_indirection< U > other; };
...
#define EIGEN_WORKAROUND_MSVC_STL_SUPPORT( T ) typename Eigen::internal::conditional< Eigen::internal::is_arithmetic< T >::value, T, Eigen::internal::workaround_msvc_stl_support< T > >::type
