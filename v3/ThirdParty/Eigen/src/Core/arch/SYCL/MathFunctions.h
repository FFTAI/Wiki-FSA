...
#define SYCL_PLOG( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type plog< packet_type >( const packet_type& a ) { \
...
#define SYCL_PLOG1P( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type plog1p< packet_type >( const packet_type& a ) { \
...
#define SYCL_PLOG10( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type plog10< packet_type >( const packet_type& a ) { \
...
#define SYCL_PEXP( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type pexp< packet_type >( const packet_type& a ) { \
...
#define SYCL_PEXPM1( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type pexpm1< packet_type >( const packet_type& a ) { \
...
#define SYCL_PSQRT( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type psqrt< packet_type >( const packet_type& a ) { \
...
#define SYCL_PRSQRT( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type prsqrt< packet_type >( const packet_type& a ) { \
...
#define SYCL_PSIN( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type psin< packet_type >( const packet_type& a ) { \
...
#define SYCL_PCOS( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type pcos< packet_type >( const packet_type& a ) { \
...
#define SYCL_PTAN( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type ptan< packet_type >( const packet_type& a ) { \
...
#define SYCL_PASIN( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type pasin< packet_type >( const packet_type& a ) { \
...
#define SYCL_PACOS( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type pacos< packet_type >( const packet_type& a ) { \
...
#define SYCL_PATAN( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type patan< packet_type >( const packet_type& a ) { \
...
#define SYCL_PSINH( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type psinh< packet_type >( const packet_type& a ) { \
...
#define SYCL_PCOSH( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type pcosh< packet_type >( const packet_type& a ) { \
...
#define SYCL_PTANH( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type ptanh< packet_type >( const packet_type& a ) { \
...
#define SYCL_PCEIL( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type pceil< packet_type >( const packet_type& a ) { \
...
#define SYCL_PROUND( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type pround< packet_type >( const packet_type& a ) { \
...
#define SYCL_PRINT( packet_type )                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type print< packet_type >( const packet_type& a ) { \
...
#define SYCL_FLOOR( packet_type )                                                                                 \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type pfloor< packet_type >( const packet_type& a ) { \
...
#define SYCL_PMIN( packet_type, expr )                                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type pmin< packet_type >( const packet_type& a, const packet_type& b ) { \
        return expr;                                                                                                                  \
    }
...
#define SYCL_PMAX( packet_type, expr )                                                                                                \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type pmax< packet_type >( const packet_type& a, const packet_type& b ) { \
        return expr;                                                                                                                  \
    }
...
#define SYCL_PLDEXP( packet_type )                                                                                              \
    template <> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type pldexp( const packet_type& a, const packet_type& exponent ) { \
