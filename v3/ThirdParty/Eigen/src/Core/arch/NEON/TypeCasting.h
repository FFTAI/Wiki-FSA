...
namespace internal {
    ...
    template <> EIGEN_STRONG_INLINE Packet4f pcast< Packet4f, Packet4f >( const Packet4f& a ) {
        return a;
    }
    template <> EIGEN_STRONG_INLINE Packet2f pcast< Packet2f, Packet2f >( const Packet2f& a ) {
        return a;
    }
...
// If float64 exists, first convert to that to keep as much precision as possible.
#if EIGEN_ARCH_ARM64
    template <> EIGEN_STRONG_INLINE Packet2l pcast< Packet4f, Packet2l >( const Packet4f& a ) {
        // Discard second half of input.
        return vcvtq_s64_f64( vcvt_f64_f32( vget_low_f32( a ) ) );
    }
    template <> EIGEN_STRONG_INLINE Packet2ul pcast< Packet4f, Packet2ul >( const Packet4f& a ) {
        // Discard second half of input.
    ...
    template <> EIGEN_STRONG_INLINE Packet2i pcast< Packet2f, Packet2i >( const Packet2f& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2ui pcast< Packet2f, Packet2ui >( const Packet2f& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet8s pcast< Packet4f, Packet8s >( const Packet4f& a, const Packet4f& b ) {
        return vcombine_s16( vmovn_s32( vcvtq_s32_f32( a ) ), vmovn_s32( vcvtq_s32_f32( b ) ) );
    }
    template <> EIGEN_STRONG_INLINE Packet4s pcast< Packet2f, Packet4s >( const Packet2f& a, const Packet2f& b ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet8us pcast< Packet4f, Packet8us >( const Packet4f& a, const Packet4f& b ) {
        return vcombine_u16( vmovn_u32( vcvtq_u32_f32( a ) ), vmovn_u32( vcvtq_u32_f32( b ) ) );
    }
    template <> EIGEN_STRONG_INLINE Packet4us pcast< Packet2f, Packet4us >( const Packet2f& a, const Packet2f& b ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet16c pcast< Packet4f, Packet16c >( const Packet4f& a, const Packet4f& b, const Packet4f& c, const Packet4f& d ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet8c pcast< Packet2f, Packet8c >( const Packet2f& a, const Packet2f& b, const Packet2f& c, const Packet2f& d ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet16uc pcast< Packet4f, Packet16uc >( const Packet4f& a, const Packet4f& b, const Packet4f& c, const Packet4f& d ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet8uc pcast< Packet2f, Packet8uc >( const Packet2f& a, const Packet2f& b, const Packet2f& c, const Packet2f& d ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2f pcast< Packet8c, Packet2f >( const Packet8c& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2l pcast< Packet16c, Packet2l >( const Packet16c& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2ul pcast< Packet16c, Packet2ul >( const Packet16c& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2i pcast< Packet8c, Packet2i >( const Packet8c& a ) {
        // Discard all but first 2 bytes.
    ...
    template <> EIGEN_STRONG_INLINE Packet2ui pcast< Packet8c, Packet2ui >( const Packet8c& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet4s pcast< Packet8c, Packet4s >( const Packet8c& a ) {
        // Discard second half of input.
    ...
    template <> EIGEN_STRONG_INLINE Packet4us pcast< Packet8c, Packet4us >( const Packet8c& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet16c pcast< Packet16c, Packet16c >( const Packet16c& a ) {
        return a;
    }
    template <> EIGEN_STRONG_INLINE Packet8c pcast< Packet8c, Packet8c >( const Packet8c& a ) {
        return a;
    }
    template <> EIGEN_STRONG_INLINE Packet4c pcast< Packet4c, Packet4c >( const Packet4c& a ) {
        return a;
    }
    ...
    template <> EIGEN_STRONG_INLINE Packet8uc pcast< Packet8c, Packet8uc >( const Packet8c& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2f pcast< Packet8uc, Packet2f >( const Packet8uc& a ) {
        // Discard all but first 2 bytes.
    ...
    template <> EIGEN_STRONG_INLINE Packet2ul pcast< Packet16uc, Packet2ul >( const Packet16uc& a ) {
        // Discard all but first two bytes.
    ...
    template <> EIGEN_STRONG_INLINE Packet2l pcast< Packet16uc, Packet2l >( const Packet16uc& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2ui pcast< Packet8uc, Packet2ui >( const Packet8uc& a ) {
        // Discard all but first 2 bytes.
    ...
    template <> EIGEN_STRONG_INLINE Packet2i pcast< Packet8uc, Packet2i >( const Packet8uc& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet4us pcast< Packet8uc, Packet4us >( const Packet8uc& a ) {
        // Discard second half of input.
    ...
    template <> EIGEN_STRONG_INLINE Packet4s pcast< Packet8uc, Packet4s >( const Packet8uc& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet16uc pcast< Packet16uc, Packet16uc >( const Packet16uc& a ) {
        return a;
    }
    template <> EIGEN_STRONG_INLINE Packet8uc pcast< Packet8uc, Packet8uc >( const Packet8uc& a ) {
        return a;
    }
    template <> EIGEN_STRONG_INLINE Packet4uc pcast< Packet4uc, Packet4uc >( const Packet4uc& a ) {
        return a;
    }
    ...
    template <> EIGEN_STRONG_INLINE Packet8c pcast< Packet8uc, Packet8c >( const Packet8uc& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2f pcast< Packet4s, Packet2f >( const Packet4s& a ) {
        // Discard second half of input.
    ...
    template <> EIGEN_STRONG_INLINE Packet2l pcast< Packet8s, Packet2l >( const Packet8s& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2ul pcast< Packet8s, Packet2ul >( const Packet8s& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2i pcast< Packet4s, Packet2i >( const Packet4s& a ) {
        // Discard second half of input.
    ...
    template <> EIGEN_STRONG_INLINE Packet2ui pcast< Packet4s, Packet2ui >( const Packet4s& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet8s pcast< Packet8s, Packet8s >( const Packet8s& a ) {
        return a;
    }
    template <> EIGEN_STRONG_INLINE Packet4s pcast< Packet4s, Packet4s >( const Packet4s& a ) {
        return a;
    }
    ...
    template <> EIGEN_STRONG_INLINE Packet16c pcast< Packet8s, Packet16c >( const Packet8s& a, const Packet8s& b ) {
        return vcombine_s8( vmovn_s16( a ), vmovn_s16( b ) );
    }
    template <> EIGEN_STRONG_INLINE Packet8c pcast< Packet4s, Packet8c >( const Packet4s& a, const Packet4s& b ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet16uc pcast< Packet8s, Packet16uc >( const Packet8s& a, const Packet8s& b ) {
        return vcombine_u8( vmovn_u16( vreinterpretq_u16_s16( a ) ), vmovn_u16( vreinterpretq_u16_s16( b ) ) );
    }
    template <> EIGEN_STRONG_INLINE Packet8uc pcast< Packet4s, Packet8uc >( const Packet4s& a, const Packet4s& b ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2f pcast< Packet4us, Packet2f >( const Packet4us& a ) {
        // Discard second half of input.
    ...
    template <> EIGEN_STRONG_INLINE Packet2ul pcast< Packet8us, Packet2ul >( const Packet8us& a ) {
        // Discard all but first two values.
    ...
    template <> EIGEN_STRONG_INLINE Packet2l pcast< Packet8us, Packet2l >( const Packet8us& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2ui pcast< Packet4us, Packet2ui >( const Packet4us& a ) {
        // Discard second half of input.
    ...
    template <> EIGEN_STRONG_INLINE Packet2i pcast< Packet4us, Packet2i >( const Packet4us& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet8us pcast< Packet8us, Packet8us >( const Packet8us& a ) {
        return a;
    }
    template <> EIGEN_STRONG_INLINE Packet4us pcast< Packet4us, Packet4us >( const Packet4us& a ) {
        return a;
    }
    ...
    template <> EIGEN_STRONG_INLINE Packet16uc pcast< Packet8us, Packet16uc >( const Packet8us& a, const Packet8us& b ) {
        return vcombine_u8( vmovn_u16( a ), vmovn_u16( b ) );
    }
    template <> EIGEN_STRONG_INLINE Packet8uc pcast< Packet4us, Packet8uc >( const Packet4us& a, const Packet4us& b ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet16c pcast< Packet8us, Packet16c >( const Packet8us& a, const Packet8us& b ) {
        return vreinterpretq_s8_u8( pcast< Packet8us, Packet16uc >( a, b ) );
    }
    template <> EIGEN_STRONG_INLINE Packet8c pcast< Packet4us, Packet8c >( const Packet4us& a, const Packet4us& b ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2f pcast< Packet2i, Packet2f >( const Packet2i& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2l pcast< Packet4i, Packet2l >( const Packet4i& a ) {
        // Discard second half of input.
    ...
    template <> EIGEN_STRONG_INLINE Packet2ul pcast< Packet4i, Packet2ul >( const Packet4i& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet4i pcast< Packet4i, Packet4i >( const Packet4i& a ) {
        return a;
    }
    template <> EIGEN_STRONG_INLINE Packet2i pcast< Packet2i, Packet2i >( const Packet2i& a ) {
        return a;
    }
    ...
    template <> EIGEN_STRONG_INLINE Packet8s pcast< Packet4i, Packet8s >( const Packet4i& a, const Packet4i& b ) {
        return vcombine_s16( vmovn_s32( a ), vmovn_s32( b ) );
    }
    template <> EIGEN_STRONG_INLINE Packet4s pcast< Packet2i, Packet4s >( const Packet2i& a, const Packet2i& b ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet8us pcast< Packet4i, Packet8us >( const Packet4i& a, const Packet4i& b ) {
        return vcombine_u16( vmovn_u32( vreinterpretq_u32_s32( a ) ), vmovn_u32( vreinterpretq_u32_s32( b ) ) );
    }
    template <> EIGEN_STRONG_INLINE Packet4us pcast< Packet2i, Packet4us >( const Packet2i& a, const Packet2i& b ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet16c pcast< Packet4i, Packet16c >( const Packet4i& a, const Packet4i& b, const Packet4i& c, const Packet4i& d ) {
        const int16x8_t ab_s16 = pcast< Packet4i, Packet8s >( a, b );
        const int16x8_t cd_s16 = pcast< Packet4i, Packet8s >( c, d );
        return vcombine_s8( vmovn_s16( ab_s16 ), vmovn_s16( cd_s16 ) );
    }
    template <> EIGEN_STRONG_INLINE Packet8c pcast< Packet2i, Packet8c >( const Packet2i& a, const Packet2i& b, const Packet2i& c, const Packet2i& d ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet16uc pcast< Packet4i, Packet16uc >( const Packet4i& a, const Packet4i& b, const Packet4i& c, const Packet4i& d ) {
        const uint16x8_t ab_u16 = pcast< Packet4i, Packet8us >( a, b );
        const uint16x8_t cd_u16 = pcast< Packet4i, Packet8us >( c, d );
        return vcombine_u8( vmovn_u16( ab_u16 ), vmovn_u16( cd_u16 ) );
    }
    template <> EIGEN_STRONG_INLINE Packet8uc pcast< Packet2i, Packet8uc >( const Packet2i& a, const Packet2i& b, const Packet2i& c, const Packet2i& d ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2f pcast< Packet2ui, Packet2f >( const Packet2ui& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2ul pcast< Packet4ui, Packet2ul >( const Packet4ui& a ) {
        // Discard second half of input.
    ...
    template <> EIGEN_STRONG_INLINE Packet2l pcast< Packet4ui, Packet2l >( const Packet4ui& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet4ui pcast< Packet4ui, Packet4ui >( const Packet4ui& a ) {
        return a;
    }
    template <> EIGEN_STRONG_INLINE Packet2ui pcast< Packet2ui, Packet2ui >( const Packet2ui& a ) {
        return a;
    }
    ...
    template <> EIGEN_STRONG_INLINE Packet8us pcast< Packet4ui, Packet8us >( const Packet4ui& a, const Packet4ui& b ) {
        return vcombine_u16( vmovn_u32( a ), vmovn_u32( b ) );
    }
    template <> EIGEN_STRONG_INLINE Packet4us pcast< Packet2ui, Packet4us >( const Packet2ui& a, const Packet2ui& b ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet8s pcast< Packet4ui, Packet8s >( const Packet4ui& a, const Packet4ui& b ) {
        return vreinterpretq_s16_u16( pcast< Packet4ui, Packet8us >( a, b ) );
    }
    template <> EIGEN_STRONG_INLINE Packet4s pcast< Packet2ui, Packet4s >( const Packet2ui& a, const Packet2ui& b ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet16uc pcast< Packet4ui, Packet16uc >( const Packet4ui& a, const Packet4ui& b, const Packet4ui& c, const Packet4ui& d ) {
        const uint16x8_t ab_u16 = vcombine_u16( vmovn_u32( a ), vmovn_u32( b ) );
        const uint16x8_t cd_u16 = vcombine_u16( vmovn_u32( c ), vmovn_u32( d ) );
        return vcombine_u8( vmovn_u16( ab_u16 ), vmovn_u16( cd_u16 ) );
    }
    template <> EIGEN_STRONG_INLINE Packet8uc pcast< Packet2ui, Packet8uc >( const Packet2ui& a, const Packet2ui& b, const Packet2ui& c, const Packet2ui& d ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet16c pcast< Packet4ui, Packet16c >( const Packet4ui& a, const Packet4ui& b, const Packet4ui& c, const Packet4ui& d ) {
        return vreinterpretq_s8_u8( pcast< Packet4ui, Packet16uc >( a, b, c, d ) );
    }
    template <> EIGEN_STRONG_INLINE Packet8c pcast< Packet2ui, Packet8c >( const Packet2ui& a, const Packet2ui& b, const Packet2ui& c, const Packet2ui& d ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet4f pcast< Packet2l, Packet4f >( const Packet2l& a, const Packet2l& b ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2l pcast< Packet2l, Packet2l >( const Packet2l& a ) {
        return a;
    }
    ...
    template <> EIGEN_STRONG_INLINE Packet4i pcast< Packet2l, Packet4i >( const Packet2l& a, const Packet2l& b ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet4ui pcast< Packet2l, Packet4ui >( const Packet2l& a, const Packet2l& b ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet8s pcast< Packet2l, Packet8s >( const Packet2l& a, const Packet2l& b, const Packet2l& c, const Packet2l& d ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet8us pcast< Packet2l, Packet8us >( const Packet2l& a, const Packet2l& b, const Packet2l& c, const Packet2l& d ) {
    ...
    template <>
    EIGEN_STRONG_INLINE Packet16c pcast< Packet2l, Packet16c >( const Packet2l& a, const Packet2l& b, const Packet2l& c, const Packet2l& d, const Packet2l& e, const Packet2l& f, const Packet2l& g,
                                                                const Packet2l& h ) {
    ...
    template <>
    EIGEN_STRONG_INLINE Packet16uc pcast< Packet2l, Packet16uc >( const Packet2l& a, const Packet2l& b, const Packet2l& c, const Packet2l& d, const Packet2l& e, const Packet2l& f, const Packet2l& g,
                                                                  const Packet2l& h ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet4f pcast< Packet2ul, Packet4f >( const Packet2ul& a, const Packet2ul& b ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2ul pcast< Packet2ul, Packet2ul >( const Packet2ul& a ) {
        return a;
    }
    ...
    template <> EIGEN_STRONG_INLINE Packet4ui pcast< Packet2ul, Packet4ui >( const Packet2ul& a, const Packet2ul& b ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet4i pcast< Packet2ul, Packet4i >( const Packet2ul& a, const Packet2ul& b ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet8us pcast< Packet2ul, Packet8us >( const Packet2ul& a, const Packet2ul& b, const Packet2ul& c, const Packet2ul& d ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet8s pcast< Packet2ul, Packet8s >( const Packet2ul& a, const Packet2ul& b, const Packet2ul& c, const Packet2ul& d ) {
    ...
    template <>
    EIGEN_STRONG_INLINE Packet16uc pcast< Packet2ul, Packet16uc >( const Packet2ul& a, const Packet2ul& b, const Packet2ul& c, const Packet2ul& d, const Packet2ul& e, const Packet2ul& f,
    ...
    template <>
    EIGEN_STRONG_INLINE Packet16c pcast< Packet2ul, Packet16c >( const Packet2ul& a, const Packet2ul& b, const Packet2ul& c, const Packet2ul& d, const Packet2ul& e, const Packet2ul& f,
                                                                 const Packet2ul& g, const Packet2ul& h ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2d pcast< Packet2d, Packet2d >( const Packet2d& a ) {
        return a;
    }
    ...
    template <> EIGEN_STRONG_INLINE Packet2ul pcast< Packet2d, Packet2ul >( const Packet2d& a ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet4ui pcast< Packet2d, Packet4ui >( const Packet2d& a, const Packet2d& b ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet8s pcast< Packet2d, Packet8s >( const Packet2d& a, const Packet2d& b, const Packet2d& c, const Packet2d& d ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet8us pcast< Packet2d, Packet8us >( const Packet2d& a, const Packet2d& b, const Packet2d& c, const Packet2d& d ) {
    ...
    template <>
    EIGEN_STRONG_INLINE Packet16c pcast< Packet2d, Packet16c >( const Packet2d& a, const Packet2d& b, const Packet2d& c, const Packet2d& d, const Packet2d& e, const Packet2d& f, const Packet2d& g,
                                                                const Packet2d& h ) {
    ...
    template <>
    EIGEN_STRONG_INLINE Packet16uc pcast< Packet2d, Packet16uc >( const Packet2d& a, const Packet2d& b, const Packet2d& c, const Packet2d& d, const Packet2d& e, const Packet2d& f, const Packet2d& g,
                                                                  const Packet2d& h ) {
    ...
    template <> EIGEN_STRONG_INLINE Packet2d pcast< Packet16c, Packet2d >( const Packet16c& a ) {
        // Discard all but first two values.
    ...
    template <> EIGEN_STRONG_INLINE Packet2d pcast< Packet16uc, Packet2d >( const Packet16uc& a ) {
        // Discard all but first two values.
    ...
    template <> EIGEN_STRONG_INLINE Packet2d pcast< Packet8s, Packet2d >( const Packet8s& a ) {
        // Discard all but first two values.
    ...
    template <> EIGEN_STRONG_INLINE Packet2d pcast< Packet8us, Packet2d >( const Packet8us& a ) {
        // Discard all but first two values.
    ...
    template <> EIGEN_STRONG_INLINE Packet2d pcast< Packet4ui, Packet2d >( const Packet4ui& a ) {
        // Discard second half of input.
    ...
    template <> EIGEN_STRONG_INLINE Packet2d pcast< Packet2ul, Packet2d >( const Packet2ul& a ) {
