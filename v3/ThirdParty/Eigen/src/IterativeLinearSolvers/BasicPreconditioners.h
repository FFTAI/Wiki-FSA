...
public:
    ...
    template < typename MatType > DiagonalPreconditioner& analyzePattern( const MatType& ) {
        return *this;
    }
    ...
    template < typename MatType > DiagonalPreconditioner& compute( const MatType& mat ) {
...
public:
    ...
    template < typename MatType > explicit LeastSquareDiagonalPreconditioner( const MatType& mat ) : Base() {
        compute( mat );
    }

    template < typename MatType > LeastSquareDiagonalPreconditioner& analyzePattern( const MatType& ) {
        return *this;
    }
    ...
    template < typename MatType > LeastSquareDiagonalPreconditioner& compute( const MatType& mat ) {
        return factorize( mat );
    }
...
public:
    ...
    template < typename MatrixType > IdentityPreconditioner& analyzePattern( const MatrixType& ) {
        return *this;
    }

    template < typename MatrixType > IdentityPreconditioner& factorize( const MatrixType& ) {
        return *this;
    }

    template < typename MatrixType > IdentityPreconditioner& compute( const MatrixType& ) {
        return *this;
    }
