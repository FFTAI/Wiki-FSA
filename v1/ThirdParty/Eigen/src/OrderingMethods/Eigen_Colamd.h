...
#define COLAMD_NDEBUG
    ...
    */
    ...
    template < typename IndexType >
    static void init_scoring( IndexType n_row, IndexType n_col, RowStructure< IndexType > Row[], ColStructure< IndexType > Col[], IndexType A[], IndexType head[], double knobs[ NKnobs ],
                              IndexType* p_n_row2, IndexType* p_n_col2, IndexType* p_max_deg );

    template < typename IndexType >
    static IndexType find_ordering( IndexType n_row, IndexType n_col, IndexType Alen, RowStructure< IndexType > Row[], ColStructure< IndexType > Col[], IndexType A[], IndexType head[],
                                    IndexType n_col2, IndexType max_deg, IndexType pfree );

    template < typename IndexType > static void order_children( IndexType n_col, ColStructure< IndexType > Col[], IndexType p[] );

    template < typename IndexType > static void detect_super_cols( ColStructure< IndexType > Col[], IndexType A[], IndexType head[], IndexType row_start, IndexType row_length );
    ...
    template < typename IndexType > static inline IndexType clear_mark( IndexType n_row, RowStructure< IndexType > Row[] );
...
#define COLAMD_ASSERT( expression ) ( ( void )0 )
     ...
     */
    template < typename IndexType > inline IndexType recommended( IndexType nnz, IndexType n_row, IndexType n_col ) {
     ...
     */
    template < typename IndexType > static bool compute_ordering( IndexType n_row, IndexType n_col, IndexType Alen, IndexType* A, IndexType* p, double knobs[ NKnobs ], IndexType stats[ NStats ] ) {
        /* === Local variables ================================================== */
