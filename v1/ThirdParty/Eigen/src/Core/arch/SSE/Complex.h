...
// to leverage AVX instructions.
    ...
    template <> EIGEN_STRONG_INLINE Packet2cf pmul< Packet2cf >( const Packet2cf& a, const Packet2cf& b ) {
        ...
        return Packet2cf( _mm_add_ps( _mm_mul_ps( vec4f_swizzle1( a.v, 0, 0, 2, 2 ), b.v ), _mm_xor_ps( _mm_mul_ps( vec4f_swizzle1( a.v, 1, 1, 3, 3 ), vec4f_swizzle1( b.v, 1, 0, 3, 2 ) ), mask ) ) );
#endif
    }
...
// to leverage AVX instructions.
    ...
    template <> EIGEN_STRONG_INLINE Packet1cd pmul< Packet1cd >( const Packet1cd& a, const Packet1cd& b ) {
        ...
        return Packet1cd( _mm_add_pd( _mm_mul_pd( vec2d_swizzle1( a.v, 0, 0 ), b.v ), _mm_xor_pd( _mm_mul_pd( vec2d_swizzle1( a.v, 1, 1 ), vec2d_swizzle1( b.v, 1, 0 ) ), mask ) ) );
#endif
    }
