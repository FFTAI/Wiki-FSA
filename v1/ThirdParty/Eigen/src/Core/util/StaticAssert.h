...
#define EIGEN_STATIC_ASSERT_FIXED_SIZE( TYPE ) EIGEN_STATIC_ASSERT( TYPE::SizeAtCompileTime != Eigen::Dynamic, YOU_CALLED_A_FIXED_SIZE_METHOD_ON_A_DYNAMIC_SIZE_MATRIX_OR_VECTOR )

// static assertion failing if the type \a TYPE is not dynamic-size
#define EIGEN_STATIC_ASSERT_DYNAMIC_SIZE( TYPE ) EIGEN_STATIC_ASSERT( TYPE::SizeAtCompileTime == Eigen::Dynamic, YOU_CALLED_A_DYNAMIC_SIZE_METHOD_ON_A_FIXED_SIZE_MATRIX_OR_VECTOR )

// static assertion failing if the type \a TYPE is not a vector type of the given size
#define EIGEN_STATIC_ASSERT_VECTOR_SPECIFIC_SIZE( TYPE, SIZE ) EIGEN_STATIC_ASSERT( TYPE::IsVectorAtCompileTime&& TYPE::SizeAtCompileTime == SIZE, THIS_METHOD_IS_ONLY_FOR_VECTORS_OF_A_SPECIFIC_SIZE )
...
#define EIGEN_PREDICATE_SAME_MATRIX_SIZE( TYPE0, TYPE1 )                                                                                                                                    \
    ( ( int( Eigen::internal::size_of_xpr_at_compile_time< TYPE0 >::ret ) == 0 && int( Eigen::internal::size_of_xpr_at_compile_time< TYPE1 >::ret ) == 0 )                                  \
      || ( ( int( TYPE0::RowsAtCompileTime ) == Eigen::Dynamic || int( TYPE1::RowsAtCompileTime ) == Eigen::Dynamic || int( TYPE0::RowsAtCompileTime ) == int( TYPE1::RowsAtCompileTime ) ) \
           && ( int( TYPE0::ColsAtCompileTime ) == Eigen::Dynamic || int( TYPE1::ColsAtCompileTime ) == Eigen::Dynamic || int( TYPE0::ColsAtCompileTime ) == int( TYPE1::ColsAtCompileTime ) ) ) )
...
#define EIGEN_STATIC_ASSERT_SIZE_1x1( TYPE )                                                                                                                                             \
    EIGEN_STATIC_ASSERT( ( TYPE::RowsAtCompileTime == 1 || TYPE::RowsAtCompileTime == Eigen::Dynamic ) && ( TYPE::ColsAtCompileTime == 1 || TYPE::ColsAtCompileTime == Eigen::Dynamic ), \
...
#define EIGEN_STATIC_ASSERT_ARRAYXPR( Derived ) \
    EIGEN_STATIC_ASSERT( ( Eigen::internal::is_same< typename Eigen::internal::traits< Derived >::XprKind, ArrayXpr >::value ), THIS_METHOD_IS_ONLY_FOR_ARRAYS_NOT_MATRICES )

#define EIGEN_STATIC_ASSERT_SAME_XPR_KIND( Derived1, Derived2 )                                                                                                               \
    EIGEN_STATIC_ASSERT( ( Eigen::internal::is_same< typename Eigen::internal::traits< Derived1 >::XprKind, typename Eigen::internal::traits< Derived2 >::XprKind >::value ), \
