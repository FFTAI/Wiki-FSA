...
namespace internal {
    ...
    public:
        ...
        template < int UpLo > struct ConstSelfAdjointViewReturnType { typedef typename ActualMatrixType::template ConstSelfAdjointViewReturnType< UpLo >::Type Type; };
    ...
    public:
        ...
        template < int UpLo > struct ConstSelfAdjointViewReturnType { typedef ActualMatrixType Type; };
...
public:
    ...
    typename internal::enable_if< Rhs::ColsAtCompileTime != 1 && DestDerived::ColsAtCompileTime != 1 >::type _solve_with_guess_impl( const Rhs& b, MatrixBase< DestDerived >& aDest ) const {
        eigen_assert( rows() == b.rows() );
    ...
    template < typename Rhs, typename DestDerived >
    typename internal::enable_if< Rhs::ColsAtCompileTime == 1 || DestDerived::ColsAtCompileTime == 1 >::type _solve_with_guess_impl( const Rhs& b, MatrixBase< DestDerived >& dest ) const {
